		...
		$Sql="DELETE FROM [020BDCOMUN].DBO.DATOS_RSV  WHERE  USUARIO='$id_usuario' AND TIPO='CC'";
		$Sql1="DELETE FROM [020BDCOMUN].DBO.DATOS_RSV  WHERE  USUARIO='$id_usuario' AND TIPO='OT-CC'";
		$Sql2="DELETE FROM [020BDCOMUN].DBO.PRE_REQUISD  WHERE  USUARIO='$id_usuario'
		AND TIPOPRE_REQUISD='CC'";
		...
		window.location = "/overprime/inventarios/moduloreserva/archivo/pages/cargar-sin-ot";
		</script>
