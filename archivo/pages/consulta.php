...
<input type="hidden" name="tipo" value="OT-CC">
<label>RESERVA:</label>
...
<div class="col-md-3 column">
<!--  
<a href="/overprime/inventarios/moduloreserva/actualizar/actualizar-stock.php" 
class="btn btn-primary"><i class="glyphicon glyphicon-refresh"></i></a>-->
</div>
...
<li><a id="modal-491438" href="#modal-container-491438" role="button"  
data-toggle="modal"><i class="glyphicon glyphicon-cloud-upload text-success" ></i>
<label class="text-success">Subir Datos</label></a></li>
<li class="divider"></li>
<li><a d="modal-964459" href="#modal-container-964459" role="button" class="btn"
 data-toggle="modal"><i class="glyphicon glyphicon-trash text-danger" ></i>
...
DRV.CODIGO=S.STCODIGO AND STALMA='01' LEFT JOIN [011BDCOMUN].DBO.MAEART AS M ON
DRV.CODIGO=M.ACODIGO  WHERE USUARIO='$IDUSUARIO' AND  DRV.TIPO='OT-CC'  AND
...
¿Desea eliminar el código <label class="text-danger" ><b><?php echo $row[CODIGO]; ?></b></label>  de cantidad 
 <label class="text-primary" ><b><?php echo $row[CANTIDAD]; ?></b></label>  ? 
