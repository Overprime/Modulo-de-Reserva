...
<script type="text/javascript" language="javascript" src="js/jslistadoni.js"></script>

<table class="table table-bordered table-condensed" id="tabla_lista_ni">
<thead>
<tr class="success">
<th>IT</th>
...
AND MC.CASITGUI='V'   AND A.ESTADO='P' AND MC.CANUMDOC  NOT IN (SELECT NRODOCUMENTO FROM 
[020BDCOMUN].DBO.DOCUMENTO ) 
AND OT NOT IN (SELECT  CODIGOOT FROM [020BDCOMUN].DBO.CENCOSOT)
ORDER BY MC.CANUMDOC 
