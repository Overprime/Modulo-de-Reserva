...
$link=Conectarse();
$sql="SELECT  D.DENUMDOC,D.DECODIGO,M.ADESCRI,D.DECANTID,D.DEUNIDAD,D.DEITEM,
...
<td>
<?php 
if ($row[DECANTID]<=$row[CANT_DISP]) {
echo "<i class='glyphicon glyphicon-ok-circle text-primary'></i>";
}else{echo "<i class='glyphicon glyphicon-remove-circle text-danger'></i>";}
?>	
</td>
<?php 
